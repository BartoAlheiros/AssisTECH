...
public class Exe extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jCheckBox2.setText("troca de peça");

        jCheckBox3.setText("preventiva");

        jCheckBox4.setText("remoção de virus");

        jLabel5.setText("(DATA DE HOJE)");

        jLabel6.setText("Previsão de Entrega:");

        jLabel7.setText("(PREVISÃO)");
        ...
        jLabel13.setText("Selecione o Equipamento:");

        jCheckBox5.setText("instalação");

        jLabel14.setText(">>>>DADOS DO CLIENTE RETORNADOS PELA BUSCA<<<<");
